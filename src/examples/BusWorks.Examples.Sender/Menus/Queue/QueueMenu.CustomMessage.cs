...
{
    public async Task SendCustomMessage(CancellationToken cancellationToken)
    {
        AnsiConsole.Clear();
        ...
        string messageBody = JsonSerializer.Serialize(new ParkingSpotReserved(Guid.NewGuid(), DateTime.UtcNow,
