...
/// <summary>
/// Attribute to specify a topic subscription for a <see cref="ServiceBusConsumer{TMessage}"/>.
/// <para>
...
/// public class ParkEventConsumer : ServiceBusConsumer&lt;ParkEvent&gt; { ... }
/// </code>
/// </example>
...
public sealed class ServiceBusTopicAttribute(string subscriptionName) : Attribute
{
    ...
    /// <summary>
    /// When true, uses a <see cref="ServiceBusSessionProcessor"/> instead of a regular processor.
